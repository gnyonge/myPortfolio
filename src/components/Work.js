              ...
              <div className="hunsu-desc">
                ...
                <br /><br /><hr /><br />
                {
                  hunsuDesc.map((desc, index) => (
                    <div className="desc-box" key={index}>
                      <div className="desc-title">
                        <FcCheckmark size="30"/><p>{desc.title}</p>
                      </div>
            ...
            <div className="poke-box">
              ...
              <div className="desc-container">
                <div className="walk-desc1">
                  ...
                  조금 걸렸습니다. <br /><br /> 예를 들면, useState라는 hook을 쓸 때 <strong>'setState가 비동기
                  방식으로 작동한다'</strong>는 이 부분을 알지 못했었기 때문에 원하는 값을 못 얻고 
                  혼자 고민하다가 개발자 커뮤니티에서 답을 얻기도 했습니다. <br /><br />

                  포켓몬을 잡을 때 포켓몬데이터를 저장하기 위해서 <strong>Redux를 사용</strong>했습니다. 
                  Vuex와 원리는 비슷했기 때문에 기본 사용법을 검색해서 익힌 후에 바로 사용해보았습니다. 
                  Redux는 다양한 미들웨어가 있기 때문에 앞으로 배울 것이 많을 것 같아 MobX와 고민 끝에 선택했습니다.
                ...
                <div className="walk-desc2 deploy-box">
                  ...
                  프론트엔드 개발에 대해 더 욕심을 가지게 되었습니다. <br /><br /><hr /><br />
                  <div className="desc-box">
                    <div className="desc-title">
